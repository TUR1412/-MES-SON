    ...
    public partial class CreateBatch : Form
    {
        ...
        private void InitializeUI()
        {
            try
            {
                ...
                txtBatchNo.Text = GenerateBatchNo();
        ...
        /// 加载示例工单数据
        /// </summary>
        private void LoadSampleWorkOrderData()
        {
            try
            {
                ...
                // 添加示例数据
                workOrderTable.Rows.Add("WO202506090001", "产品A", "PA001", 100, 0, 100, "待生产", DateTime.Now.AddDays(-1));
                workOrderTable.Rows.Add("WO202506090002", "产品B", "PB001", 200, 50, 150, "生产中", DateTime.Now.AddDays(-2));
                workOrderTable.Rows.Add("WO202506090003", "产品C", "PC001", 150, 0, 150, "待生产", DateTime.Now);
                workOrderTable.Rows.Add("WO202506090004", "产品A", "PA001", 80, 0, 80, "待生产", DateTime.Now.AddDays(-3));
                workOrderTable.Rows.Add("WO202506090005", "产品D", "PD001", 120, 20, 100, "生产中", DateTime.Now.AddDays(-1));
            }
            catch (Exception ex)
            {
                LogManager.Error("加载示例工单数据失败", ex);
                throw;
            }
        }
        ...
        private string GenerateBatchNo()
        {
            try
            {
                ...
                int seq = random.Next(1, 9999);
                string seqStr = seq.ToString("D4");
            ...
            catch (Exception ex)
            {
                ...
                return string.Format("BATCH{0}0001", DateTime.Now.ToString("yyyyMMdd"));
            }
        }
